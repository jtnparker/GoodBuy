...
var inputFile = path.join(__dirname, './userPreferences.csv')
var table = 'userTable'
...
const tableCreate = 'CREATE TABLE IF NOT EXISTS userTable(id integer NOT null, name text NOT null, hrc BOOLEAN NOT null, peta BOOLEAN NOT null, fairtrade BOOLEAN NOT null)';
